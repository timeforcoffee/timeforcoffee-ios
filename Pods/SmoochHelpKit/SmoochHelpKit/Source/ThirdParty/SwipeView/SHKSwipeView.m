...
- (CGSize)swipeViewItemSize:(__unused SHKSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused SHKSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused SHKSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused SHKSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused SHKSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused SHKSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused SHKSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused SHKSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused SHKSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused SHKSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface SHKSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<SHKSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<SHKSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(SHKSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case SHKSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case SHKSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == SHKSwipeViewAlignmentCenter)
        {
