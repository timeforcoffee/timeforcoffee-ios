...
//#ifndef SHKLECOLORPICKER
//#define SHKLECOLORPICKER
//
//#ifdef LE_DEBUG
...
@interface SHKLEColorScheme : NSObject
@property(nonatomic,strong)UIColor *backgroundColor;
@property(nonatomic,strong)UIColor *primaryTextColor;
@property(nonatomic,strong)UIColor *secondaryTextColor;
@end

@interface SHKLEColorPicker : NSObject
{
    //GLuint _vertexArray;
 ...
 */
- (SHKLEColorScheme*)colorSchemeFromImage:(UIImage*)image;
 ...
 */
- (void)pickColorsFromImage:(UIImage*)image onComplete:(void (^)(SHKLEColorScheme *colorScheme))completeBlock;
